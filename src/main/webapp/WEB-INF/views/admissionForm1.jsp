...
<hr> 
		<form:form action="saveAdmissison" modelAttribute="admissionDto" method="post" enctype="multipart/form-data" onsubmit="return validateform()">
			...
			<tr> <td><div class="form-group col-md-6">
					<label >Name </label> <form:input type="text" class="form-control form-control-lg" id="name"  path="name" placeholder="Name"/>
				</div> 
			</td>
			<td> 
...
<td> 			<div class="form-group col-md-6">
					<label for="form:inputEmail4">Religion</label> <form:input type="text" class="form-control form-control-lg" id="religion" path="religion" placeholder="Religion"/>
				</div>
			</td>
			</tr>
			<tr> 
			...
			<td>	<div class="form-group col-md-6">
					<label >Father Name</label> <form:input type="text" class="form-control form-control-lg" id="fName" path="fName" placeholder="Father Name"/>
				</div>
			</td>
			<td><label >Father Occupation</label> <form:input type="text" class="form-control form-control-lg" id="fOccupation"  path="fOccupation" placeholder="Father Name"/>
				</div>
			</td>
			<td><div class="form-group col-md-6">
					<label for="form:inputEmail4">Mother Name </label> <form:input type="text" class="form-control form-control-lg" id="mName" path="mName" placeholder="Mother Name"/>
				</div> 
			</td>
			<td><div class="form-group col-md-6">
					<label >Mother Occupation</label> <form:input type="text" class="form-control form-control-lg" id="mOccupation" path="mOccupation" placeholder="Father Name"/>
				</div>
			</td>
			</tr>
			...
			<tr> 
			<td><div class="form-group col-md-6">
					<label for="form:inputEmail4">Contact</label> <form:input type="text" class="form-control form-control-lg" id="contact" path="contact"  placeholder="Contact Number"/>
				</div>
			</td>
<td><div class="form-group col-md-6">
					<label for="form:inputEmail4">Alt-Contact</label> <form:input type="text" class="form-control form-control-lg" id="altContact" path="altContact" placeholder="Contact Number"/>
				</div>
			</td>	
<td>
<div class="form-group col-md-6">
...
<td> 				<div class="form-group col-md-6">
					<label >Scholar No</label> <form:input type="text" class="form-control form-control-lg" id="scholarNumber" path="scholarNumber" placeholder="Scholar Number"/>
				</div>
			</td><td> 	<div class="form-group col-md-6">
					<label for="form:inputEmail4">Last School Studied</label> 
				</div>
				</td>
</tr>
					<tr> 
			...
			<td> 
				<div class="form-group col-md-6">
					<label >Account No</label> <form:input type="text" class="form-control form-control-lg" id="accNo" path="accNo" placeholder="Account No"/>
				</div>
				</td> <td> <div class="form-group col-md-6">
					<label for="form:inputEmail4">IFSC Code</label> <form:input type="text" class="form-control form-control-lg" id="ifsc" path="ifsc" placeholder="IFSC Code"/>
				</div>
				</td>
<td> 			<div class="form-group">
				<label for="form:inputAddress">Address</label> <form:input type="text" class="form-control form-control-lg" id="address" path="address" placeholder="Please Provide Address"/>
			</div>
	</td>
			<td> 
				<div class="form-group col-md-6">
					<label for="form:inputCity">City</label> <form:input type="text" class="form-control form-control-lg" id="city" path="city"/>
				</div>
</td></tr>	
<td> 			<div class="form-group col-md-6">
					...
					<label for="form:inputZip">Zip</label> <form:input type="text" class="form-control form-control-lg" id="zip" path="zip"/>
				</div>
		</td>
		<td><div class="form-group col-md-6">
					<label for="form:inputEmail4">Samagra ID</label> <form:input type="text" class="form-control form-control-lg" id="samagraId" path="samagraId" placeholder="Samagra ID "/>
				</div>
			</td>
			
			<td> 		<div class="form-group col-md-6">
					<label for="form:inputEmail4">Bank Details</label> <form:input type="text" class="form-control form-control-lg" id="bankName" path="bankName" placeholder="Bank Names "/>
				</div>
			</td>
		</tr> 
	<tr> <td> 			<div class="form-group col-md-6">
...
<td> 				<div class="form-group col-md-6">
					<label for="form:inputEmail4">Place of Birth</label> <form:input type="text" class="form-control form-control-lg" id="birthPlace" path="birthPlace" placeholder="Place Of  Birth"/>
				</div>
	</td>
...
<tr> <td> 
			...
			<td><div class="form-group col-md-6">
					<label for="form:inputEmail4">Aadhar No</label> <form:input type="text" class="form-control form-control-lg" id="aadhar" path="aadhar" placeholder="Aadhar Number"/>
				</div>
			</td>
			<td><div class="form-group col-md-6">
